...
class ConclusionDictionary_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$param = new FieldExtText('descr'
			...
			$this->setUpdateModelId('ConclusionDictionary_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('ConclusionDictionary_Model');		
