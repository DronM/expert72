...
class DocFlowInsideDialog_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("doc_flow_inside_dialog");
		...
		//*** Field doc_flow_inside_processes_chain ***
		$f_opts = array();
		$f_opts['id']="doc_flow_inside_processes_chain";
						
		$f_doc_flow_inside_processes_chain=new FieldSQLJSON($this->getDbLink(),$this->getDbName(),$this->getTableName(),"doc_flow_inside_processes_chain",$f_opts);
		$this->addField($f_doc_flow_inside_processes_chain);
		//********************
