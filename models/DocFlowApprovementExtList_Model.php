...
class DocFlowApprovementExtList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("doc_flow_approvements_ext_list");
		...
		$f_recipient_list=new FieldSQLText($this->getDbLink(),$this->getDbName(),$this->getTableName(),"recipient_list",$f_opts);
