...
class DocFlowFulfilment_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("doc_flow_fulfilments");
		...
		$f_opts = array();
		$f_opts['id']="check_employee_id";
				
		$f_check_employee_id=new FieldSQLInt($this->getDbLink(),$this->getDbName(),$this->getTableName(),"check_employee_id",$f_opts);
		$this->addField($f_check_employee_id);
		//********************
		
		//*** Field supervise_employee_id ***
		$f_opts = array();
		$f_opts['id']="supervise_employee_id";
				
		$f_supervise_employee_id=new FieldSQLInt($this->getDbLink(),$this->getDbName(),$this->getTableName(),"supervise_employee_id",$f_opts);
		$this->addField($f_supervise_employee_id);
		//********************
