...
class EmployeeWithExpertCertificateList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("employees_expert_certificate_list");
		...
		$f_cert_list=new FieldSQLJSON($this->getDbLink(),$this->getDbName(),$this->getTableName(),"cert_list",$f_opts);
		$this->addField($f_cert_list);
		//********************
