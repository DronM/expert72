...
CREATE OR REPLACE VIEW applications_dialog AS
	...
	LEFT JOIN
		...
		LEFT JOIN doc_flow_out AS adf_out ON adf_out.id=adf.application_id AND adf_out.doc_flow_type_id=(pdfn_doc_flow_types_app_resp()->'keys'->>'id')::int)
