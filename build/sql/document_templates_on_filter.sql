...
$$
  ...
  COST 100;
ALTER FUNCTION document_templates_on_filter(id_date date, in_construction_type_id int, in_service_type service_types, in_expertise_type expertise_types) OWNER TO ;
