...
BEGIN
	...
	IF res IS NULL THEN		
		...
		IF res IS NULL THEN		
			UPDATE contracts
			SET contract_ext_id=in_contract_ext_id
			WHERE id=res;
		END IF;		
	END IF;
...
$$
  ...
  COST 100;
ALTER FUNCTION contracts_find(in_contract_ext_id varchar(36), in_contract_number text, in_contract_date date) OWNER TO expert72;
