 ...
 */
function Conclusion_tFinance_Container(id,options){
	options = options || {};	
		
	options.readOnly = false;//close!!!
	
	this.m_xmlNodeName = "Finance";
	...
	options.elementOptions.addElement = function(){
		this.addElement(new Conclusion_tFinance_View(this.getId()+":Finance",{
			"name":"Finance"
		...
		this.addElement(new Control(this.getId()+":cmdClose","A",{
			"title":"Удалить источник финансирования"
			,"attrs":{"notForValue":"true"}
			,"events":{				
				"click":function(){
					WindowQuestion.show({
						"text":"Удалить источник финансирования?",
						"cancel":false,
	...
	options.addElement = function(){
		this.addElement(new ButtonCmd(this.getId()+":cmdAdd",{
			"title":"Добавить источник финансирования",
			"caption":"Добавить сведения об источнике финансирования",
			"onClick":function(){
	...
	Conclusion_tFinance_Container.superclass.constructor.call(this,id,options);
}
extend(Conclusion_tFinance_Container,BaseContainerXML);//
