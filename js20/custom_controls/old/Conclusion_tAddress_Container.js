 ...
 */
function Conclusion_tAddress_Container(id,options){
	options = options || {};	
	...
	options.elementOptions.addElement = function(){
		this.addElement(new Conclusion_tAddress(this.getId()+":Address",{
			"labelCaption":"Адрес РФ"
		}));
		var self = this;
	...
	Conclusion_tAddress_Container.superclass.constructor.call(this,id,options);
}
extend(Conclusion_tAddress_Container,BaseContainerXML);//
