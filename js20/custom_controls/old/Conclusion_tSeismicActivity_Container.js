 ...
 */
function Conclusion_tSeismicActivity_Container(id,options){
	options = options || {};	
	...
	options.elementOptions.addElement = function(){
		this.addElement(new ConclusionDictionaryDetailSelect(this.getId()+":SeismicActivity",{
	...
	options.addElement = function(){
		this.addElement(new ButtonCmd(this.getId()+":cmdAdd",{
			"title":"Добавить интенсивность сейсмических воздействий",
			"caption":"Добавить интенсивность сейсмических воздействий",
			"onClick":function(){
	...
	Conclusion_tSeismicActivity_Container.superclass.constructor.call(this,id,options);
}
extend(Conclusion_tSeismicActivity_Container,BaseContainerXML);//
