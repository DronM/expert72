 ...
 * @param {string} [options.asyncRefresh=false]!!! Для экспертизы!!!
...
function EditSelectRef(id,options){
	...
	this.m_asyncRefresh = (options.asyncRefresh!=undefined)? options.asyncRefresh:false;
...
//console.log("EditSelectRef.prototype.setInitValue "+this.getName())

	this.setValue(val);	
	
	if (typeof val == "object"){
		this.m_initValue = this.getValue();//val;
		this.setInitKeys(this.getKeys());
	}	
}
