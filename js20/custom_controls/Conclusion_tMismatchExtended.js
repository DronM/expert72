 ...
 */
function Conclusion_tMismatchExtended(id,options){
	options = options || {};	
	...
	options.addElement = function(){
		...
		this.addElement(new ConclusionDictionaryDetailSelect(id+":ExpertType",{
			...
			,"labelCaption":"Направление деятельности, в части которого сформулированы сведения о несоответствии:"
			,"name":"ExpertType"
	...
	Conclusion_tMismatchExtended.superclass.constructor.call(this,id,options);
}
//ViewObjectAjx,ViewAjxList
extend(Conclusion_tMismatchExtended,EditXML);
...
//****************** VIEW **********************
function Conclusion_tMismatchExtended_View(id,options){
	options = options || {};
	options.viewClass = Conclusion_tMismatchExtended;
	options.viewOptions = {"name": options["name"]};
	//options.viewTemplate = "Conclusion_tMismatchExtended_View";
	options.headTitle = "Сведения о несоответствии'";
	options.dialogWidth = "50%";
	
	Conclusion_tMismatchExtended_View.superclass.constructor.call(this,id,options);

}
extend(Conclusion_tMismatchExtended_View,EditModalDialogXML);
