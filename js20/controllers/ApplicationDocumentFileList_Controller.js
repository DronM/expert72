...
function ApplicationDocumentFileList_Controller(options){
	options = options || {};
	options.listModelClass = ApplicationDocumentFileList_Model;
	options.objModelClass = ApplicationDocumentFileList_Model;
	ApplicationDocumentFileList_Controller.superclass.constructor.call(this,options);	
...
extend(ApplicationDocumentFileList_Controller,ControllerObjServer);

			ApplicationDocumentFileList_Controller.prototype.addUpdate = function(){
	ApplicationDocumentFileList_Controller.superclass.addUpdate.call(this);
	...
	pm.addField(field);
			...
			ApplicationDocumentFileList_Controller.prototype.addDelete = function(){
	ApplicationDocumentFileList_Controller.superclass.addDelete.call(this);
	...
	pm.addField(new FieldString("file_id",options));
			...
			ApplicationDocumentFileList_Controller.prototype.addGetObject = function(){
	ApplicationDocumentFileList_Controller.superclass.addGetObject.call(this);
	...
	pm.addField(new FieldString("mode"));
			...
			ApplicationDocumentFileList_Controller.prototype.addGetList = function(){
	ApplicationDocumentFileList_Controller.superclass.addGetList.call(this);
