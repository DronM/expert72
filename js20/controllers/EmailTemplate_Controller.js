...
extend(EmailTemplate_Controller,ControllerObjServer);
	...
	options.enumValues = 'new_account,reset_pwd,user_email_conf,out_mail,new_app,app_change,new_remind,out_mail_to_app,contract_state_change,app_to_correction,contr_return,expert_work_change';
