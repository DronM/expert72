...
function Signature_Model(options){
	var id = 'Signature_Model';
	options = options || {};
	...
	options.fields.owner = new FieldJSON("owner",filed_options);
	...
	options.fields.sign_date_time = new FieldDateTimeTZ("sign_date_time",filed_options);
		...
		Signature_Model.superclass.constructor.call(this,id,options);
}
extend(Signature_Model,ModelXML);
