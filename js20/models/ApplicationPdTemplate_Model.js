...
function ApplicationPdTemplate_Model(options){
	var id = 'ApplicationPdTemplate_Model';
	options = options || {};
	...
	options.fields.date_time = new FieldDateTimeTZ("date_time",filed_options);
		...
		ApplicationPdTemplate_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationPdTemplate_Model,ModelXML);
