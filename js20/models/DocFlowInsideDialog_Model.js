...
function DocFlowInsideDialog_Model(options){
	var id = 'DocFlowInsideDialog_Model';
	options = options || {};
	...
	options.fields.doc_flow_inside_processes_chain = new FieldJSON("doc_flow_inside_processes_chain",filed_options);
	
		DocFlowInsideDialog_Model.superclass.constructor.call(this,id,options);
}
