...
function DocFlowRegistrationDialog_Model(options){
	var id = 'DocFlowRegistrationDialog_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		DocFlowRegistrationDialog_Model.superclass.constructor.call(this,id,options);
}
