...
function Conclusion_Model(options){
	var id = 'Conclusion_Model';
	options = options || {};
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'XML заключение';
	filed_options.autoInc = false;	
	...
	options.fields.content_hash = new FieldString("content_hash",filed_options);
	options.fields.content_hash.getValidator().setMaxLength('36');
	
			
			
			
		Conclusion_Model.superclass.constructor.call(this,id,options);
}
extend(Conclusion_Model,ModelXML);
