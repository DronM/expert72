...
function DocFlowApprovementExtList_Model(options){
	var id = 'DocFlowApprovementExtList_Model';
	options = options || {};
	...
	options.fields.recipient_list = new FieldText("recipient_list",filed_options);
	...
	options.fields.employee_id = new FieldInt("employee_id",filed_options);
		...
		DocFlowApprovementExtList_Model.superclass.constructor.call(this,id,options);
}
extend(DocFlowApprovementExtList_Model,ModelXML);
