...
function DocFlowExamination_Model(options){
	var id = 'DocFlowExamination_Model';
	options = options || {};
	...
	options.fields.recipient.getValidator().setRequired(true);
	...
	options.fields.description.getValidator().setRequired(true);
	...
	filed_options.enumValues = 'filling,correcting,sent,checking,returned,closed_no_expertise,waiting_for_contract,waiting_for_pay,expertise,closed,archive';
		...
		DocFlowExamination_Model.superclass.constructor.call(this,id,options);
}
