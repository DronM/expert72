...
function ConstantList_Model(options){
	...
	options.fields.ctrl_class = new FieldText("ctrl_class",filed_options);
	...
	options.fields.ctrl_options = new FieldJSON("ctrl_options",filed_options);
	...
	options.fields.view_class = new FieldText("view_class",filed_options);
	...
	options.fields.view_options = new FieldJSON("view_options",filed_options);
