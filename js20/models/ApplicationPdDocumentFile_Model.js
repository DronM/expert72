...
function ApplicationPdDocumentFile_Model(options){
	var id = 'ApplicationPdDocumentFile_Model';
	options = options || {};
	...
	options.fields.deleted_dt = new FieldDateTimeTZ("deleted_dt",filed_options);
		...
		ApplicationPdDocumentFile_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationPdDocumentFile_Model,ModelXML);
