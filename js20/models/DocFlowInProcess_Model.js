...
function DocFlowInProcess_Model(options){
	var id = 'DocFlowInProcess_Model';
	options = options || {};
	...
	options.fields.doc_flow_in_id.getValidator().setRequired(true);
	...
	filed_options.enumValues = 'examining,examined,fulfilling,fulfilled,acquainting,acquainted,registered,registering';
	...
	options.fields.end_date_time = new FieldDateTimeTZ("end_date_time",filed_options);
		...
		DocFlowInProcess_Model.superclass.constructor.call(this,id,options);
}
