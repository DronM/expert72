...
function ApplicationCorrection_Model(options){
	var id = 'ApplicationCorrection_Model';
	options = options || {};
	...
	options.fields.doc_flow_examination_id = new FieldInt("doc_flow_examination_id",filed_options);
	
			
		ApplicationCorrection_Model.superclass.constructor.call(this,id,options);
}
