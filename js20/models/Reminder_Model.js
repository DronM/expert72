...
function Reminder_Model(options){
	var id = 'Reminder_Model';
	options = options || {};
	...
	options.fields.recipient_employee_id = new FieldInt("recipient_employee_id",filed_options);
	options.fields.recipient_employee_id.getValidator().setRequired(true);
	...
	options.fields.viewed_dt = new FieldDateTimeTZ("viewed_dt",filed_options);
	...
	options.fields.register_docs_ref = new FieldJSONB("register_docs_ref",filed_options);
	...
	options.fields.doc_flow_importance_type_id = new FieldInt("doc_flow_importance_type_id",filed_options);
		...
		Reminder_Model.superclass.constructor.call(this,id,options);
}
