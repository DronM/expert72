...
function DocExpertiseTemplateList_Model(options){
	var id = 'DocExpertiseTemplateList_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		DocExpertiseTemplateList_Model.superclass.constructor.call(this,id,options);
}
extend(DocExpertiseTemplateList_Model,ModelXML);
