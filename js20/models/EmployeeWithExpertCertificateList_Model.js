...
function EmployeeWithExpertCertificateList_Model(options){
	var id = 'EmployeeWithExpertCertificateList_Model';
	options = options || {};
	...
	options.fields.cert_list = new FieldJSON("cert_list",filed_options);
	
		EmployeeWithExpertCertificateList_Model.superclass.constructor.call(this,id,options);
}
extend(EmployeeWithExpertCertificateList_Model,ModelXML);
