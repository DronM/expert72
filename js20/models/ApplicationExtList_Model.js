...
function ApplicationExtList_Model(options){
	var id = 'ApplicationExtList_Model';
	options = options || {};
	...
	options.fields.office_descr = new FieldText("office_descr",filed_options);
	...
	options.fields.expert_work_end_date = new FieldDate("expert_work_end_date",filed_options);
		...
		ApplicationExtList_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationExtList_Model,ModelXML);
