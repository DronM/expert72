...
function ReportTemplateFile_Model(options){
	var id = 'ReportTemplateFile_Model';
	options = options || {};
	...
	options.fields.report_template_id = new FieldInt("report_template_id",filed_options);
	...
	options.fields.view_ar = new FieldArray("view_ar",filed_options);
	...
	options.fields.employee_id = new FieldInt("employee_id",filed_options);
		...
		ReportTemplateFile_Model.superclass.constructor.call(this,id,options);
}
