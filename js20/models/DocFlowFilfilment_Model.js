...
function DocFlowFilfilment_Model(options){
	var id = 'DocFlowFilfilment_Model';
	options = options || {};
	...
	options.fields.subject_doc_id = new FieldInt("subject_doc_id",filed_options);
	...
	options.fields.recipients = new FieldJSONB("recipients",filed_options);
	...
	options.fields.check_employee_id = new FieldInt("check_employee_id",filed_options);
	...
	options.fields.supervise_employee_id = new FieldInt("supervise_employee_id",filed_options);
	
			
			
		DocFlowFilfilment_Model.superclass.constructor.call(this,id,options);
}
