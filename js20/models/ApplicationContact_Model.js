...
function ApplicationContact_Model(options){
	var id = 'ApplicationContact_Model';
	options = options || {};
	...
	options.fields.client_type.getValidator().setMaxLength('15');
	...
	options.fields.firm_name.getValidator().setMaxLength('250');
		...
		ApplicationContact_Model.superclass.constructor.call(this,id,options);
}
