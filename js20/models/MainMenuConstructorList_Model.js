...
function MainMenuConstructorList_Model(options){
	var id = 'MainMenuConstructorList_Model';
	options = options || {};
	...
	options.fields.user_id = new FieldString("user_id",filed_options);
	...
	options.fields.content = new FieldText("content",filed_options);
		...
		MainMenuConstructorList_Model.superclass.constructor.call(this,id,options);
}
