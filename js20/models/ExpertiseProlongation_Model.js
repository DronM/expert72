...
function ExpertiseProlongation_Model(options){
	var id = 'ExpertiseProlongation_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		ExpertiseProlongation_Model.superclass.constructor.call(this,id,options);
}
extend(ExpertiseProlongation_Model,ModelXML);
