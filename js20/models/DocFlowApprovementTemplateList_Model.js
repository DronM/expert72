...
function DocFlowApprovementTemplateList_Model(options){
	var id = 'DocFlowApprovementTemplateList_Model';
	options = options || {};
	...
	options.fields.for_all_employees = new FieldBool("for_all_employees",filed_options);
		...
		DocFlowApprovementTemplateList_Model.superclass.constructor.call(this,id,options);
}
