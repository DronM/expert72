...
function ApplicationDostDocumentFile_Model(options){
	var id = 'ApplicationDostDocumentFile_Model';
	options = options || {};
	...
	options.fields.document_id = new FieldInt("document_id",filed_options);
	options.fields.document_id.getValidator().setRequired(true);
	...
	options.fields.file_name = new FieldText("file_name",filed_options);
	...
	options.fields.deleted_dt = new FieldDateTimeTZ("deleted_dt",filed_options);
		...
		ApplicationDostDocumentFile_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationDostDocumentFile_Model,ModelXML);
