...
function OutMailStateHistory_Model(options){
	var id = 'OutMailStateHistory_Model';
	options = options || {};
	...
	options.fields.out_mail_id.getValidator().setRequired(true);
	...
	filed_options.enumValues = 'dirt_copy,according,registered';
	...
	options.fields.end_date_time = new FieldDateTimeTZ("end_date_time",filed_options);
		...
		OutMailStateHistory_Model.superclass.constructor.call(this,id,options);
}
extend(OutMailStateHistory_Model,ModelXML);
