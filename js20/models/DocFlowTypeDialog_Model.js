...
function DocFlowTypeDialog_Model(options){
	var id = 'DocFlowTypeDialog_Model';
	options = options || {};
	...
	options.fields.doc_flow_types_type_id = new FieldString("doc_flow_types_type_id",filed_options);
	...
	options.fields.def_intervals = new FieldJSONB("def_intervals",filed_options);
