...
function ApplicationForExpertMaintenanceList_Model(options){
	var id = 'ApplicationForExpertMaintenanceList_Model';
	options = options || {};
	...
	options.fields.applicant_name = new FieldString("applicant_name",filed_options);
	...
	options.fields.customer_name = new FieldString("customer_name",filed_options);
	...
	options.fields.service_list = new FieldString("service_list",filed_options);
	...
	options.fields.expertise_result_date = new FieldDate("expertise_result_date",filed_options);
		...
		ApplicationForExpertMaintenanceList_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationForExpertMaintenanceList_Model,ModelXML);
