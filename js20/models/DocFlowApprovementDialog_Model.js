...
function DocFlowApprovementDialog_Model(options){
	var id = 'DocFlowApprovementDialog_Model';
	options = options || {};
	...
	options.fields.recipient_list_ref = new FieldJSON("recipient_list_ref",filed_options);
	...
	options.fields.doc_flow_approvement_type = new FieldString("doc_flow_approvement_type",filed_options);
	...
	options.fields.step_count = new FieldInt("step_count",filed_options);
		...
		DocFlowApprovementDialog_Model.superclass.constructor.call(this,id,options);
}
