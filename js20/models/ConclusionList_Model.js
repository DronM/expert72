...
function ConclusionList_Model(options){
	var id = 'ConclusionList_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		ConclusionList_Model.superclass.constructor.call(this,id,options);
}
extend(ConclusionList_Model,ModelXML);
