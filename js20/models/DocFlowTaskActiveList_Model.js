...
function DocFlowTaskActiveList_Model(options){
	var id = 'DocFlowTaskActiveList_Model';
	options = options || {};
	...
	DocFlowTaskActiveList_Model.superclass.constructor.call(this,id,options);
}
extend(DocFlowTaskActiveList_Model,ModelXML);
