...
function ApplicationRespPerson_Model(options){
	var id = 'ApplicationRespPerson_Model';
	options = options || {};
	...
	options.fields.client_type.getValidator().setMaxLength('12');
	...
	options.fields.tel.getValidator().setMaxLength('15');
		...
		ApplicationRespPerson_Model.superclass.constructor.call(this,id,options);
}
