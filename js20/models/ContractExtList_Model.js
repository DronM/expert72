...
function ContractExtList_Model(options){
	var id = 'ContractExtList_Model';
	options = options || {};
	...
	ContractExtList_Model.superclass.constructor.call(this,id,options);
}
extend(ContractExtList_Model,ModelXML);
