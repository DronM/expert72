...
function DocFlowFulfilment_Model(options){
	var id = 'DocFlowFulfilment_Model';
	options = options || {};
	...
	options.fields.supervise_employee_id = new FieldInt("supervise_employee_id",filed_options);
		...
		DocFlowFulfilment_Model.superclass.constructor.call(this,id,options);
}
extend(DocFlowFulfilment_Model,ModelXML);
