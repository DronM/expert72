...
function ChatMessage_Model(options){
	var id = 'ChatMessage_Model';
	options = options || {};
	...
	options.fields.parent_chat_message_id = new FieldInt("parent_chat_message_id",filed_options);
		...
		ChatMessage_Model.superclass.constructor.call(this,id,options);
}
extend(ChatMessage_Model,ModelXML);
