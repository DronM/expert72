...
function DocFlowOutExtList_Model(options){
	var id = 'DocFlowOutExtList_Model';
	options = options || {};
	...
	options.fields.employee_short_name = new FieldString("employee_short_name",filed_options);
	...
	options.fields.applicant_descr = new FieldText("applicant_descr",filed_options);
		...
		DocFlowOutExtList_Model.superclass.constructor.call(this,id,options);
}
extend(DocFlowOutExtList_Model,ModelXML);
