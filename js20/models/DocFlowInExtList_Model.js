...
function DocFlowInExtList_Model(options){
	var id = 'DocFlowInExtList_Model';
	options = options || {};
	...
	options.fields.recipient = new FieldJSON("recipient",filed_options);
	...
	options.fields.sender = new FieldString("sender",filed_options);
	...
	options.fields.sender_construction_name = new FieldString("sender_construction_name",filed_options);
	...
	options.fields.corrected_sections = new FieldText("corrected_sections",filed_options);
		...
		DocFlowInExtList_Model.superclass.constructor.call(this,id,options);
}
extend(DocFlowInExtList_Model,ModelXML);
