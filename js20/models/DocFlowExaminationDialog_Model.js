...
function DocFlowExaminationDialog_Model(options){
	var id = 'DocFlowExaminationDialog_Model';
	options = options || {};
	...
	options.fields.resolution = new FieldText("resolution",filed_options);
	...
	options.fields.application_based = new FieldBool("application_based",filed_options);
	...
	options.fields.doc_flow_in_processes_chain = new FieldJSON("doc_flow_in_processes_chain",filed_options);
	...
	options.fields.doc_flow_out_ref = new FieldJSON("doc_flow_out_ref",filed_options);
