...
function ApplicationTemplate_Model(options){
	var id = 'ApplicationTemplate_Model';
	options = options || {};
	...
	options.fields.date_time = new FieldDateTimeTZ("date_time",filed_options);
		...
		ApplicationTemplate_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationTemplate_Model,ModelXML);
