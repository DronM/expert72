...
function InMailDialog_Model(options){
	var id = 'InMailDialog_Model';
	options = options || {};
	...
	options.fields.files = new FieldJSON("files",filed_options);
		...
		InMailDialog_Model.superclass.constructor.call(this,id,options);
}
extend(InMailDialog_Model,ModelXML);
