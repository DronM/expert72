...
function DocCostEvalValidityTemplate_Model(options){
	var id = 'DocCostEvalValidityTemplate_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		DocCostEvalValidityTemplate_Model.superclass.constructor.call(this,id,options);
}
extend(DocCostEvalValidityTemplate_Model,ModelXML);
