...
function ReportTemplateFileList_Model(options){
	var id = 'ReportTemplateFileList_Model';
	options = options || {};
	...
	options.fields.report_templates_name = new FieldString("report_templates_name",filed_options);
	...
	options.fields.employee_id = new FieldInt("employee_id",filed_options);
		...
		ReportTemplateFileList_Model.superclass.constructor.call(this,id,options);
}
