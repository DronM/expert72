...
function DocFlowOutProcess_Model(options){
	var id = 'DocFlowOutProcess_Model';
	options = options || {};
	...
	filed_options.enumValues = 'approving,not_approved,approved_with_notes,approved,confirming,not_confirmed,registered,registering';
	...
	options.fields.end_date_time = new FieldDateTimeTZ("end_date_time",filed_options);
		...
		DocFlowOutProcess_Model.superclass.constructor.call(this,id,options);
}
