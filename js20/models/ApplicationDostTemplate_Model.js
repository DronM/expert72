...
function ApplicationDostTemplate_Model(options){
	var id = 'ApplicationDostTemplate_Model';
	options = options || {};
	...
	options.fields.date_time = new FieldDateTimeTZ("date_time",filed_options);
		...
		ApplicationDostTemplate_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationDostTemplate_Model,ModelXML);
