...
function BuildTypeList_Model(options){
	var id = 'BuildTypeList_Model';
	options = options || {};
	...
	options.fields.document_types_ref = new FieldJSON("document_types_ref",filed_options);
		...
		BuildTypeList_Model.superclass.constructor.call(this,id,options);
}
extend(BuildTypeList_Model,ModelXML);
