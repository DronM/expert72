...
function DocFlowExaminationExtList_Model(options){
	var id = 'DocFlowExaminationExtList_Model';
	options = options || {};
	...
	options.fields.employee_id = new FieldInt("employee_id",filed_options);
		...
		DocFlowExaminationExtList_Model.superclass.constructor.call(this,id,options);
}
extend(DocFlowExaminationExtList_Model,ModelXML);
