...
function DocCostEvalValidityTemplateList_Model(options){
	var id = 'DocCostEvalValidityTemplateList_Model';
	options = options || {};
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		DocCostEvalValidityTemplateList_Model.superclass.constructor.call(this,id,options);
}
extend(DocCostEvalValidityTemplateList_Model,ModelXML);
