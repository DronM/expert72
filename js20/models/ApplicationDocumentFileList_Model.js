...
function ApplicationDocumentFileList_Model(options){
	var id = 'ApplicationDocumentFileList_Model';
	options = options || {};
	...
	options.fields.information_list = new FieldBool("information_list",filed_options);
		...
		ApplicationDocumentFileList_Model.superclass.constructor.call(this,id,options);
}
extend(ApplicationDocumentFileList_Model,ModelXML);
