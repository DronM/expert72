...
function ClientPersonRegistrPaper_Model(options){
	var id = 'ClientPersonRegistrPaper_Model';
	options = options || {};
	...
	options.fields.issue_date = new FieldDate("issue_date",filed_options);
		...
		ClientPersonRegistrPaper_Model.superclass.constructor.call(this,id,options);
}
