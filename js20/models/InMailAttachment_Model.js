...
function InMailAttachment_Model(options){
	var id = 'InMailAttachment_Model';
	options = options || {};
	...
	options.fields.in_mail_id = new FieldInt("in_mail_id",filed_options);
...
extend(InMailAttachment_Model,ModelXML);
