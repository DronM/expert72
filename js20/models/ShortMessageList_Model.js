...
function ShortMessageList_Model(options){
	...
	options.fields.to_recipients_ref = new FieldJSON("to_recipients_ref",filed_options);
	...
	options.fields.view_date_time = new FieldDateTimeTZ("view_date_time",filed_options);
