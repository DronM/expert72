 ...
 */	
function ApplicationDostTemplate_View(id,options){	

	options = options || {};
	
	options.model = options.models.ApplicationDostTemplate_Model;
	options.controller = new ApplicationDostTemplate_Controller();
	
	ApplicationDostTemplate_View.superclass.constructor.call(this,id,options);
	...
	this.addElement(new TreeAjx(id+":content",{
		...
		"rootCaption":"РАЗДЕЛЫ ДОСТОВЕРНОСТИ",
...
extend(ApplicationDostTemplate_View,ViewObjectAjx);
