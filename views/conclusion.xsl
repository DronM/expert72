...
<!-- Начало основного шаблона -->
    ...
    <html>
        <head>
            <style type="text/css">
                h1 { font-family: Times New Roman; font-size: 20pt; font-weight:bold; text-align:center; width:100%; margin-top: 0; }
                p {font-family: Times New Roman; font-size: 14pt; margin-bottom: 5px; text-indent: 30px; margin-top: 0;  text-align: justify;}
                body{font-family: Times New Roman; font-size: 14pt; margin:0;}

                .title {font-size: 16pt; font-weight:bold; text-align:center; text-indent: 0px; margin-bottom: 5px;}
                .no-first-line {text-indent: 0px;}
                .field {font-weight: bold; }
                .center {text-align:center; text-indent: 0px;}
                .right {text-align:right;}
                .left {text-align:left;}
                .organization {text-align:left; text-indent: 0px;}
                .expert {text-align:left; text-indent: 0px; font-size: 12pt;}
                .title_org_name {font-size: 20pt; text-align:center; font-weight:bold;}
                .title_org_data {font-size: 14pt;  text-align:center;}
                .pagebreak {page-break-before: always; }

                table {border-collapse: collapse; width:100%; margin:2em 0; font-family: Times New Roman; font-size: 12pt;}
                td {border: 1px solid black; padding: 0.2em 0.5em; vertical-align: top; font-family: Times New Roman; font-size: 11pt;}
                td.main {border: 0px; padding: 0.2em 0.5em; vertical-align: top;}
                td.number {border: 1px solid black; font-family: Times New Roman; font-size: 18pt; text-align: center;}
            </style>
        </head>
        ...
        <body>
            <div align="center" style="width: 800px; position: absolute; left: 50%; margin-left: -400px;">
                            ...
                            <p class="title_org_name">
                                ...
                                <br />
                                &quot;<xsl:value-of select="substring-after(ExpertOrganization/OrgFullName,'&quot;')" />
                                </xsl:if>
                            ...
                            <p class="right">
                                Утверждено <br/><xsl:value-of select="Approver/FamilyName"/><xsl:text disable-output-escaping="yes"><![CDATA[ ]]></xsl:text><xsl:value-of select="Approver/FirstName"/><xsl:text disable-output-escaping="yes"><![CDATA[ ]]></xsl:text><xsl:value-of select="Approver/SecondName"/><br/>
                            ...
                            <p class="organization">
                                <xsl:choose>
                                    <xsl:when test="Declarant/Organization"><xsl:apply-templates select="Declarant/Organization"/></xsl:when>
                                    <xsl:when test="Declarant/ForeignOrganization"><xsl:apply-templates select="Declarant/ForeignOrganization"/></xsl:when>
                                    <xsl:when test="Declarant/IP"><xsl:apply-templates select="Declarant/IP"/></xsl:when>
                                    <xsl:when test="Declarant/Person"><xsl:apply-templates select="Declarant/Person"/></xsl:when>
                                </xsl:choose>
                            </p>
                            <br/>
                            ...
                            <xsl:for-each select="Documents/Document[DocType!='01.01' and DocType!='01.02' and (DocType &lt; '06.01' or DocType &gt; '08.99') and File]">
                                <xsl:sort select="DocType"/>
                                <p>
                                    <xsl:number value="position()" format="1. "/>
                                    <xsl:apply-templates select="."/>
                ...
                <xsl:variable name="DocsNum" select="count(Documents/Document[DocType!='01.01' and DocType!='01.02' and (DocType &lt; '06.01' or DocType &gt; '08.99') and File])"/>
                            <xsl:if test="Documents/Document[DocType &gt; '06.00' and  DocType &lt; '07.00' and File]">
                                <p><xsl:number value="$DocsNum+1" format="1. "/> Результаты инженерных изысканий (<xsl:value-of select="count(Documents/Document[DocType &gt; '06.00' and  DocType &lt; '07.00' and File])"/> документ(ов) - <xsl:value-of select="count(Documents/Document[DocType &gt; '05.99' and  DocType &lt; '07.00']/File)"/> файл(ов))</p>
                            </xsl:if>
                            <xsl:if test="Documents/Document[DocType &gt; '07.00' and  DocType &lt; '09.00' and File]">
                                <p>
                                    ...
                                    Проектная документация (<xsl:value-of select="count(Documents/Document[DocType &gt; '07.00' and  DocType &lt; '09.00' and File])"/> документ(ов) - <xsl:value-of select="count(Documents/Document[DocType &gt; '07.00' and  DocType &lt; '09.00']/File)"/> файл(ов))</p>
                            </xsl:if>
                            ...
                            <xsl:if test="PreviousConclusions">
                                <p class="title">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="ExaminationObject/ExaminationStage=1">Сведения о ранее выданных заключениях экспертизы в отношении объекта капитального строительства, проектная документация и (или) результаты инженерных изысканий по которому представлены для проведения экспертизы</xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=2">Сведения о ранее выданных заключениях экспертизы проектной документации и (или) результатов инженерных изысканий в отношении объекта капитального строительства, проектная документация и (или) результаты инженерных изысканий по которому представлены для проведения повторной экспертизы</xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=3">Сведения о ранее выданных заключениях экспертизы в отношении объекта капитального строительства, проектная документация по которому представлена для проведения оценки соответствия в рамках экспертного сопровождения</xsl:when>
                                    </xsl:choose>
                                </p>
                            ...
                            <xsl:if test="ExaminationObject/ExaminationStage=3 and PreviousSimpleConclusions">
                                <p class="title">1.7. Сведения о ранее выданных заключениях по результатам оценки соответствия в рамках экспертного сопровождения в отношении объекта капитального строительства, проектная документация по которому представлена для проведения оценки соответствия в рамках экспертного сопровождения</p>
                            ...
                            <p class="title">
                                <xsl:choose>
                                    ...
                                    <xsl:when test="ExaminationObject/ExaminationStage=3">
                                        II. Сведения, содержащиеся в документах, представленных для проведения оценки соответствия проектной документации в рамках экспертного сопровождения
                                    </xsl:when>
                                </xsl:choose>
                            </p>
                            <br/>
                            ...
                            <xsl:choose>
                                <xsl:when test="Finance[FinanceType=1] or Finance[FinanceType=2]">
                                    <table style='border-style: solid; border-width:1px; border-collapse: collapse; align: center;'>
                                        <tr>
                                            <td style='width: 40%; border-style: solid; border-width:1px; font-weight: bold; text-align: center;'>Источник финансирования</td>
                                        ...
                                        <xsl:for-each select="Finance">
                                            <tr>
                                                <td style='border-style: solid; border-width:1px; text-align: center;'>
                                                    <xsl:choose>
                                                        <xsl:when test="FinanceType=1">
                                                            Бюджетные средства
                                                        </xsl:when>
                                                        <xsl:when test="FinanceType=2">
                                                            Средства юридических лиц, перечисленных в части 2 статьи 48.2 ГрК РФ
                                                        </xsl:when>
                                                        <xsl:when test="FinanceType=3">
                                                            Средства, не входящие в перечень, указанный в части 2 статьи 8.3 Градостроительного кодекса Российской Федерации
                                                        </xsl:when>
                                                    </xsl:choose>
                                                </td>
                                                <td class="organization">
                                                    <xsl:if test="FinanceType=1">
                                                        <xsl:choose>
                                                            <xsl:when test="BudgetType=1">
                                                                Федеральный бюджет
                                                            </xsl:when>
                                                            <xsl:when test="BudgetType=2">
                                                                Бюджет субъекта Российской Федерации
                                                            </xsl:when>
                                                            <xsl:when test="BudgetType=3">
                                                                Местный бюджет
                                                            </xsl:when>
                                                            <xsl:when test="BudgetType=4">
                                                                Бюджет территориального государственного внебюджетного фонда
                                                            </xsl:when>
                                                            <xsl:when test="BudgetType=5">
                                                                Бюджет государственного внебюджетного фонда Российской Федерации
                                                            </xsl:when>
                                                        </xsl:choose>
                                                    </xsl:if>
                ...
                <xsl:if test="ClimateConditions">
                            <p>Климатический район, подрайон:
                                <xsl:for-each select="ClimateConditions/ClimateDistrict">
                                    <xsl:value-of select="."/>
                                    <xsl:if test="position() != last()">, </xsl:if>
                                </xsl:for-each>
                            </p>
                            <p>Геологические условия:
                            ...
                            <p>Сейсмическая активность (баллов):
                            ...
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:for-each select="ExpertConclusion[ExpertEngineeringSurveys[EngineeringSurveyConditions!='']]">
                                        <br/>
                                        <p class="title">
                                            <xsl:choose>
                                            ...
                                            <xsl:call-template name="MakeRII">
                                                <xsl:with-param name="TypeCode" select="ExpertEngineeringSurveys/EngineeringSurveyType"/>
                                            </xsl:call-template>:
                                        </p>
                                        <xsl:call-template name="StringReplace">
                                            <xsl:with-param name="input" select="ExpertEngineeringSurveys/EngineeringSurveyConditions"/>
                                        </xsl:call-template>
                    ...
                    <p>Сведения о природных и техногенных условиях территории, на которой планируется осуществлять строительство, реконструкцию, капитальный ремонт объекта капитального строительства не представлены.</p>
                            ...
                            <xsl:if test="not($ExType='РИИ')">
                                <p class="title">
                                    <xsl:choose>
                                        <xsl:when test="ExaminationObject/ExaminationStage=1">
                                            2.5. Сведения об индивидуальных предпринимателях и (или) юридических лицах, подготовивших проектную документацию
                                        </xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=2">
                                ...
                                <p class="organization">
                                    <xsl:choose>
                                        <xsl:when test="Organization"><xsl:apply-templates select="Organization"/></xsl:when>
                                        <xsl:when test="ForeignOrganization"><xsl:apply-templates select="ForeignOrganization"/></xsl:when>
                                        <xsl:when test="IP"><xsl:apply-templates select="IP"/></xsl:when>
                                    </xsl:choose>
                                </p>
                                    <br/>
                                </xsl:for-each>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="EEPDUse/EEPDNote">
                                            <xsl:if test="EEPDUse/EEPDNote != ''">
                                                <xsl:value-of select="EEPDUse/EEPDNote"/>.
                                            </xsl:if>
                                            <xsl:if test="EEPDUse/EEPDNumber">
                                                <xsl:if test="EEPDUse/EEPDNumber != ''">
                                                    Положительное заключение экспертизы от <xsl:call-template name="formatdate">
                                                        <xsl:with-param name="DateTimeStr" select="EEPDUse/EEPDDate"/>
                                                    </xsl:call-template> № <xsl:value-of select="EEPDUse/EEPDNumber"/>
                                                </xsl:if>
                                            </xsl:if>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <p style='font-size: 14pt; text-align: justify; text-indent: 30px;'>Использование проектной документации повторного использования при подготовке проектной документации не предусмотрено.</p>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </p>
                                <br/>
                            ...
                            <xsl:if test="not($ExType='РИИ')">
                                ...
                                <xsl:call-template name="StringReplace">
                                    <xsl:with-param name="input" select="ProjectTaskNote"/>
                                </xsl:call-template>
                                <xsl:if test="not(Documents/Document[DocType='05.03']) and not(ProjectTaskNote)">
                            ...
                            <xsl:if test="not($ExType='РИИ') and not($ExType='ПДОСС')">
                                ...
                                <xsl:call-template name="StringReplace">
                                    <xsl:with-param name="input" select="TerritoryPlanNote"/>
                                </xsl:call-template>
                                <xsl:if test="not(Documents/Document[DocType &gt; '03.00' and DocType &lt; '04.00']) and not(TerritoryPlanNote)">
                                    <p>Сведения отсутствуют.</p>
                                </xsl:if>
                                <br/>
                            </xsl:if>
                            ...
                            <xsl:if test="not($ExType='РИИ') and not($ExType='ПДОСС')">
                                ...
                                <xsl:call-template name="StringReplace">
                                    <xsl:with-param name="input" select="NetworkNote"/>
                                </xsl:call-template>
                                <xsl:if test="not(Documents/Document[DocType='04.01']) and not(NetworkNote)">
                                    <p>Сведения отсутствуют.</p>
                                </xsl:if>
                                <br/>
                            </xsl:if>
                            ...
                            <xsl:if test="not($ExType='РИИ')">
                                <p class="title">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="ExaminationObject/ExaminationStage=1">
                                            Сведения о застройщике (техническом заказчике), обеспечившем подготовку проектной документации
                                        </xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=2 or ExaminationObject/ExaminationStage=3">
                                            Сведения о застройщике (техническом заказчике), обеспечившем подготовку изменений в проектную документацию
                                        </xsl:when>
                                    </xsl:choose>
                                </p>
                                <br/>
                                <xsl:if test="count(ProjectDocumentsDeveloper)=1">
                                    <p class="field">Застройщик:</p>
                                </xsl:if>
                                <xsl:if test="count(ProjectDocumentsDeveloper)&gt;1">
                                    <p class="field">Застройщики:</p>
                                </xsl:if>
                                    ...
                                    <xsl:for-each select="ProjectDocumentsDeveloper">
                                        <p class="organization">
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="ForeignOrganization"><xsl:apply-templates select="ForeignOrganization"/></xsl:when>
                                                <xsl:when test="IP"><xsl:apply-templates select="IP"/></xsl:when>
                                                <xsl:when test="Person"><xsl:apply-templates select="Person"/></xsl:when>
                                            </xsl:choose>
                                        </p>
                                        <br/>
                                    </xsl:for-each>
                                ...
                                <xsl:if test="count(ProjectDocumentsTechnicalCustomer)=1">
                                    <p class="field">Технический заказчик:</p>
                                </xsl:if>
                                <xsl:if test="count(ProjectDocumentsTechnicalCustomer)&gt;1">
                                    <p class="field">Технические заказчики:</p>
                                </xsl:if>
                            ...
                            <xsl:if test="$ExType='РИИ' or $ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС'">
                                ...
                                <p class="title">
                                    <xsl:choose>
                                        <xsl:when test="ExaminationObject/ExaminationStage=1">
                                            III. Сведения, содержащиеся в документах, представленных для проведения экспертизы результатов инженерных изысканий
                                        </xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=2">
                                            III. Сведения, содержащиеся в документах, представленных для проведения повторной экспертизы результатов инженерных изысканий
                                        </xsl:when>
                                    </xsl:choose>
                                </p>
                                <br/>
                                ...
                                <p class="title">
                                    <xsl:choose>
                                        <xsl:when test="ExaminationObject/ExaminationStage=1">
                                            3.3. Сведения о застройщике (техническом заказчике), обеспечившем проведение инженерных изысканий
                                        </xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=2">
                                            3.3. Сведения о застройщике (техническом заказчике), обеспечившем подготовку изменений в результаты инженерных изысканий
                                        </xsl:when>
                                    </xsl:choose>
                                </p>
                                <br/>
                                ...
                                <p class="title">
                                    3.4. Сведения о задании застройщика (технического заказчика) на выполнение инженерных изысканий
                                </p>
                                ...
                                <p class="title">
                                    3.5. Сведения о программе инженерных изысканий
                                </p>
                                ...
                                <xsl:for-each select="ExpertConclusion[ExpertIngeneeringSurveys]">
                                    <xsl:if test="ExpertEngineeringSurveys/EngineeringSurveyProgramNote!=''">
                                        <p>
                                            <b>
                                                <xsl:call-template name="MakeRII">
                                                    <xsl:with-param name="TypeCode" select="ExpertEngineeringSurveys/EngineeringSurveyType"/>
                                        ...
                                        <xsl:call-template name="StringReplace">
                                            <xsl:with-param name="input" select="ExpertEngineeringSurveys/EngineeringSurveyProgramNote"/>
                                        </xsl:call-template>
                            ...
                            <xsl:if test="$ExType='РИИ' or $ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС'">
                                ...
                                <p class="title">
                                    4.1. Описание результатов инженерных изысканий
                                </p>
                                <br/>

                                <!-- Вывод cведений о составе отчетных материалов о результатах инженерных изысканий -->
                                <p class="title">
                                    <xsl:if test="ExaminationObject/ExaminationStage=1">
                                    4.1.1. Состав отчетной документации о выполнении инженерных изысканий (с учетом изменений, внесенных в ходе проведения экспертизы)
                                    </xsl:if>
                                    <xsl:if test="ExaminationObject/ExaminationStage=2">
                                        4.1.1. Состав отчетной документации о выполнении инженерных изысканий (с учетом изменений, внесенных в ходе проведения повторной экспертизы)
                                    </xsl:if>
                                </p>
                                <table style='border-style: solid; border-width:1px; border-collapse: collapse; align: center; width: 100%;'>
                                    <tr>
                                ...
                                <xsl:choose>
                                    <xsl:when test="ExaminationObject/ExaminationStage=1">
                                        <p class="title">4.1.2. Сведения о методах выполнения инженерных изысканий </p>
                                        <xsl:for-each select="ExpertConclusion[ExpertEngineeringSurveys[EngineeringSurveyMethods!='']]">
                                            <br/>
                                            <p class="title">
                                            ...
                                            <xsl:call-template name="StringReplace">
                                                <xsl:with-param name="input" select="ExpertEngineeringSurveys/EngineeringSurveyMethods"/>
                                            </xsl:call-template>
                                        </xsl:for-each>
                                    </xsl:when>

                                    <xsl:when test="ExaminationObject/ExaminationStage=2">
                                        <p class="title">4.1.2. Описание изменений, внесенных в результаты инженерных изысканий после проведения предыдущей экспертизы </p>
                                        <xsl:for-each select="ExpertConclusion[ExpertEngineeringSurveys[EngineeringSurveyChangesPrevious!='']]">
                                            <br/>
                                            <p class="title">
                                                4.1.2.<xsl:number value="position()" format ="1. " />
                                                <xsl:call-template name="MakeRII">
                                            ...
                                            <xsl:call-template name="StringReplace">
                                                <xsl:with-param name="input" select="ExpertEngineeringSurveys/EngineeringChangesPrevious"/>
                                            </xsl:call-template>
                                        </xsl:for-each>
                                    </xsl:when>
                                </xsl:choose>
                                ...
                                <p class="title">
                                    4.1.3. Сведения об оперативных изменениях, внесенных заявителем в результаты инженерных изысканий в процессе проведения экспертизы
                                </p>
                                <xsl:for-each select="ExpertConclusion[ExpertEngineeringSurveys[EngineeringSurveyChanges!='']]">
                                    <br/>
                                    <p class="title">
                                        4.1.3.<xsl:number value="position()" format ="1. " />
                                        <xsl:call-template name="MakeRII">
                                            <xsl:with-param name="TypeCode" select="ExpertEngineeringSurveys/EngineeringSurveyType"/>
                                        </xsl:call-template>:
                                    </p>
                                    ...
                                    <xsl:call-template name="StringReplace">
                                        <xsl:with-param name="input" select="ExpertEngineeringSurveys/EngineeringSurveyChanges"/>
                                    </xsl:call-template>
                            ...
                            <xsl:if test="not($ExType='РИИ')">
                                ...
                                <table style='border-style: solid; border-width:1px; border-collapse: collapse; align: center; width: 100%;'>
                                    ...
                                    <xsl:if test="Documents/Document[DocType &gt;'07.04' and DocType &lt;'07.12' and File]">
                                        <tr>
                                            <td colspan="5"><p class="title">Сведения об инженерном оборудовании, о сетях инженерно-технического обеспечения, перечень инженерно-технических мероприятий, содержание технологических решений</p></td>
                                        </tr>
                                    </xsl:if>
                                    <xsl:call-template name="ProjectDocumentsDocTable">
                                ...
                                <xsl:if test="not($ExType='ПДОСС')">
                                    ...
                                    <xsl:for-each select="ExpertConclusion[ExpertProjectDocuments[ProjectDocumentsReview!='']]">
                                        ...
                                        <p>
                                            <xsl:call-template name="StringReplace">
                                                <xsl:with-param name="input" select="ExpertProjectDocuments/ProjectDocumentsReview"/>
                                            </xsl:call-template>
                                        </p>
                                    </xsl:for-each>
                                    <br/>
                                    ...
                                    <xsl:if test="ExaminationObject/ExaminationStage!=3 and not($ExType='РИИ' or $ExType='ПДОСС')">
                                        <p class="title">
                                            <xsl:choose>
                                                <xsl:when test="ExaminationObject/ExaminationStage=1 and ($ExType='ПД' or $ExType='ПД+ПДОСС')">3.1.3. Сведения об оперативных изменениях, внесенных заявителем в рассматриваемые разделы проектной документации в процессе проведения экспертизы</xsl:when>
                                                <xsl:when test="ExaminationObject/ExaminationStage=2 and ($ExType='ПД' or $ExType='ПД+ПДОСС')">3.1.3. Сведения об оперативных изменениях, внесенных заявителем в рассматриваемые разделы проектной документации в процессе проведения повторной экспертизы</xsl:when>
                                                <xsl:when test="ExaminationObject/ExaminationStage=1 and ($ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС')">4.2.3. Сведения об оперативных изменениях, внесенных заявителем в рассматриваемые разделы проектной документации в процессе проведения экспертизы</xsl:when>
                                                <xsl:when test="ExaminationObject/ExaminationStage=2 and ($ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС')">4.2.3. Сведения об оперативных изменениях, внесенных заявителем в рассматриваемые разделы проектной документации в процессе проведения повторной экспертизы</xsl:when>
                                            </xsl:choose>
                                        </p>
                                        <xsl:for-each select="ExpertConclusion[ExpertProjectDocuments[ProjectDocumentsChanges!='']]">
                                            <xsl:sort select="@ExpertType" />
                                            <br/>
                                            <p class="title">
                                                <xsl:choose>
                                            ...
                                            <p>
                                                <xsl:call-template name="StringReplace">
                                                    <xsl:with-param name="input" select="ExpertProjectDocuments/ProjectDocumentsChanges"/>
                                                </xsl:call-template>
                                            </p>
                                        </xsl:for-each>
                                        <br/>
                                ...
                                <xsl:if test="not($ExType='РИИ') and EstimatedCost">
                                    ...
                                    <p class="title">
                                        <xsl:choose>
                                            <xsl:when test="ExaminationObject/ExaminationStage=3 and $ExType='ПД'">3.3.1. Сведения о сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации на дату представления сметной документации для проведения проверки достоверности определения сметной стоимости и на дату утверждения заключения государственной экспертизы по результатам экспертного сопровождения</xsl:when>
                                            <xsl:when test="ExaminationObject/ExaminationStage=3 and $ExType='ПД+ПДОСС'">3.2.1. Сведения о сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации на дату представления сметной документации для проведения проверки достоверности определения сметной стоимости и на дату утверждения заключения государственной экспертизы по результатам экспертного сопровождения</xsl:when>
                                            <xsl:when test="ExaminationObject/ExaminationStage=1 and ($ExType='ПД' or $ExType='ПД+ПДОСС' or $ExType='ПДОСС')">3.2.1. Сведения о сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации на дату представления сметной документации для проведения проверки достоверности определения сметной стоимости и на дату утверждения заключения экспертизы</xsl:when>
                                            <xsl:when test="ExaminationObject/ExaminationStage=2 and ($ExType='ПД' or $ExType='ПД+ПДОСС' or $ExType='ПДОСС')">3.2.1. Сведения о сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации на дату представления сметной документации для проведения проверки достоверности определения сметной стоимости и на дату утверждения заключения повторной экспертизы</xsl:when>
                                            <xsl:when test="ExaminationObject/ExaminationStage=1 and ($ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС')">4.3.1. Сведения о сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации на дату представления сметной документации для проведения проверки достоверности определения сметной стоимости и на дату утверждения заключения экспертизы</xsl:when>
                                            <xsl:when test="ExaminationObject/ExaminationStage=2 and ($ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС')">4.3.1. Сведения о сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации на дату представления сметной документации для проведения проверки достоверности определения сметной стоимости и на дату утверждения заключения повторной экспертизы</xsl:when>
                                        </xsl:choose>
                                    </p>
                                    ...
                                    <xsl:if test="$ExType='ПД+ПДОСС' or $ExType='ПДОСС' or $ExType='РИИ+ПД+ПДОСС'">
                                        ...
                                        <xsl:for-each select="ExpertConclusion[ExpertEstimate[EstimateNorms!='']]">
                                            <br/>
                                            <p class="title">
                                                <xsl:call-template name="StringReplace">
                                                    <xsl:with-param name="input" select="ExpertEstimate/EstimateNorms"/>
                                                </xsl:call-template>
                                            </p>
                                        </xsl:for-each>
                                        <br/>
                            ...
                            <xsl:if test="$ExType='РИИ' or $ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС'">
                                <p class="title">
                                    ...
                                    <xsl:if test="ExaminationObject/ExaminationResult=2">
                                        <!-- Вывод таблицы с замечаниями -->
                                        <table>
                                            <tr>
                                                <td style="width: 10%; vertical-align: middle;"><p class="center">№ п/п</p></td>
                                                <td style="width: 50%; vertical-align: middle;"><p class="center">Выводы о несоответствии</p></td>
                                                <td style="width: 20%; vertical-align: middle;"><p class="center">Ссылка на материалы</p></td>
                                                <td style="width: 20%; vertical-align: middle;"><p class="center">Основание</p></td>
                                            </tr>
                                            <xsl:for-each select="ExpertConclusion/ExpertEngineeringSurveys[Mismatches]">
                                                ...
                                                <xsl:for-each select="Mismatches/NormsMismatch">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Link"/></p></td>
                                                    </tr>  
                                                </xsl:for-each>
                                            </xsl:for-each>
                                        </table>
                            ...
                            <xsl:if test="not($ExType='РИИ') and not($ExType='ПДОСС')">
                                ...
                                <p class="title">
                                    ...
                                    Указание на результаты инженерных изысканий, на соответствие которым проводилась оценка проектной документации
                                </p>
                                <br/>
                                <p>Оценка проектной документации проведена на соответствие результатам следующих инженерных изысканий:</p>

                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=1]]">
                                    <p>- Инженерно-геодезические изыскания</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=2]]">
                                    <p>- Инженерно-геологические изыскания</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=3]]">
                                    <p>- Инженерно-гидрометеорологические изыскания</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=4]]">
                                    <p>- Инженерно-экологические изыскания</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=5]]">
                                    <p>- Инженерно-геотехнические изыскания</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=6]]">
                                    <p>- Геотехнические исследования</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=7]]">
                                    <p>- Обследования состояния грунтов оснований зданий и сооружений, их строительных конструкций</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=8]]">
                                    <p>- Поиск и разведка подземных вод для целей водоснабжения</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=9]]">
                                    <p>- Локальный мониторинг компонентов окружающей среды</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=10]]">
                                    <p>- Разведка грунтовых строительных материалов</p>
                                </xsl:if>
                                <xsl:if test="ExpertConclusion[ExpertProjectDocuments[EngineeringSurveyType=11]]">
                                    <p>- Локальные обследования загрязнения грунтов и грунтовых вод</p>
                                </xsl:if>
                                <br/>
                                ...
                                <p class="title">
                                    <xsl:choose>
                                        <xsl:when test="ExaminationObject/ExaminationStage=3 and $ExType='ПД'">4.2. Выводы о соответствии или несоответствии технической части проектной документации результатам инженерных изысканий, заданию застройщика или технического заказчика на проектирование и требованиям технических регламентов и о совместимости или несовместимости с частью проектной документации и (или) результатами инженерных изысканий, в которые изменения не вносились</xsl:when>
                                        <xsl:when test="ExaminationObject/ExaminationStage=3 and $ExType='ПД+ПДОСС'">4.1.2. Выводы о соответствии или несоответствии технической части проектной документации результатам инженерных изысканий, заданию застройщика или технического заказчика на проектирование и требованиям технических регламентов и о совместимости или несовместимости с частью проектной документации и (или) результатами инженерных изысканий, в которые изменения не вносились</xsl:when>
                                        ...
                                        <xsl:when test="ExaminationObject/ExaminationStage=2 and ($ExType='ПД' or $ExType='ПД+ПДОСС')">4.1.2. Выводы о соответствии или несоответствии технической части проектной документации результатам инженерных изысканий, заданию застройщика или технического заказчика на проектирование и требованиям технических регламентов и о совместимости или несовместимости с частью проектной документации и (или) результатами инженерных изысканий, в которые изменения не вносились</xsl:when>
                                        ...
                                        <xsl:when test="ExaminationObject/ExaminationStage=2 and ($ExType='РИИ+ПД' or $ExType='РИИ+ПД+ПДОСС')">5.2.2. Выводы о соответствии или несоответствии технической части проектной документации результатам инженерных изысканий, заданию застройщика или технического заказчика на проектирование и требованиям технических регламентов и о совместимости или несовместимости с частью проектной документации и (или) результатами инженерных изысканий, в которые изменения не вносились</xsl:when>
                                    </xsl:choose>
                                </p>
                                <xsl:if test="ExaminationObject/ExaminationResult=2">
                                    <!-- Вывод таблицы с замечаниями -->
                                    <table>
                                        ...
                                        <xsl:for-each select="ExpertConclusion/ExpertProjectDocuments[Mismatches]">
                                            <xsl:sort select="@ExpertType" />
                                            <tr>
                                                <td style="width: 100%;" colspan="4">
                                                    <p class="title">
                                ...
                                <br/>
                                <xsl:if test="ExpertConclusion/ExpertProjectDocuments/Mismatches[DangerMismatch]">
                                    <p>
                                        Следующие решения, предусмотренные в проектной документации, в случае их реализации могут привести к риску возникновения аварийных ситуаций, гибели людей, причинения значительного материального ущерба:
                                    </p>
                                    <xsl:for-each select="ExpertConclusion/ExpertProjectDocuments[Mismatches/DangerMismatch]">
                                        <xsl:sort select="../@Experttype" />
                                        
                                        <p class="title">В части 
                                        <xsl:call-template name="MakeExpertTypeTitle">
                                            <xsl:with-param name="ExpertType" select="../@ExpertType"/>
                                        </xsl:call-template>
                                        </p>
                            ...
                            <xsl:if test="$ExType='ПДОСС' or $ExType='ПД+ПДОСС' or $ExType='РИИ+ПД+ПДОСС'">
                                ...
                                <p class="title">
                                    ...
                                    <xsl:if test="ExaminationObject/ExaminationResult=2">
                                        ...
                                        <table>
                                            ...
                                            <xsl:if test="ExpertConclusion/ExpertEstimate[Mismatches[CommonMismatch]]">
                                                <tr>
                                                    <td style="width: 100%;" colspan="4"><p class="title">Общие замечания</p></td>
                                                </tr>
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/CommonMismatch">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                            ...
                                            <xsl:if test="ExpertConclusion/ExpertEstimate[Mismatches[FullCalculationMismatch]]">
                                                <tr>
                                                    <td style="width: 100%;" colspan="4"><p class="title">Замечания по сводному сметному расчету</p></td>
                                                </tr>
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/FullCalculationMismatch">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                            ...
                                            <xsl:if test="ExpertConclusion/ExpertEstimate[Mismatches[LocalCalculationMismatch]]">
                                                <tr>
                                                    <td style="width: 100%;" colspan="4"><p class="title">Замечания по объектным и локальным сметным расчетам</p></td>
                                                </tr>
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/LocalCalculationMismatch">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                            ...
                                            <xsl:if test="ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch[@ExpertType='35.1.' or @ExpertType='17.1.']">
                                                <tr>
                                                    <td style="width: 100%;" colspan="4"><p class="title">Замечания в части соответствия расчетов, содержащихся в сметной документации, физическим объемам работ, конструктивным, организационно-технологическим и другим решениям, предусмотренным проектной документацией</p></td>
                                                </tr>
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch[@ExpertType='35.1.' or @ExpertType='17.1.']">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                            ...
                                            <xsl:if test="ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch[@ExpertType!='35.1.' and @ExpertType!='17.1.']">
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch[@ExpertType!='35.1.' and @ExpertType!='17.1.']">
                                                    <xsl:sort select="."/>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--
                                                    <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch[@ExpertType!=./@ExpertType]"> 
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                            ...
                                            <xsl:if test="ExpertConclusion/ExpertEstimate[Mismatches[BasicMismatch]]">
                                                <tr>
                                                    <td style="width: 100%;" colspan="4"><p class="title">Замечания по порядку пересчета сметной стоимости из базисного уровня цен в текущий уровень цен</p></td>
                                                </tr>
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/BasicMismatch">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                ...
                                <xsl:if test="ExaminationObject/ConstructionType=3">
                                    ...
                                    <xsl:if test="ExaminationObject/ExaminationResult=2">
                                        ...
                                        <table>
                                            ...
                                            <!-- Проверка есть ли замечания в части соответствия расчетов, содержащихся в сметной документации, физическим объемам работ, конструктивным, организационно-технологическим и другим решениям, предусмотренным проектной документацией -->
                                            <xsl:if test="ExpertConclusion/ExpertEstimate[Mismatches[ProjectDocumentsMismatch]]">
                                                <tr>
                                                    <td style="width: 100%;" colspan="4"><p class="title">Замечания в части соответствия расчетов, содержащихся в сметной документации, физическим объемам работ, включенным в ведомость объемов работ, акт, утвержденный застройщиком или техническим заказчиком</p></td>
                                                </tr>
                                                <xsl:for-each select="ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch">
                                                    <tr>
                                                        <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                                                        <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
                                ...
                                <p class="title">
                                    ...
                                    Вывод о достоверности или недостоверности определения сметной стоимости строительства, реконструкции, капитального ремонта, сноса объекта капитального строительства, работ по сохранению объектов культурного наследия (памятников истории и культуры) народов Российской Федерации
                                </p>
                                <p>
                                    <xsl:call-template name="StringReplace">
...
<!-- Вывод сведений о документе и его авторе -->
    <xsl:template match="Document">
        ...
        <xsl:choose>
            <xsl:when test="DocChanges!=''">
                (<xsl:value-of select="DocChanges"/>)
            </xsl:when>
        </xsl:choose>
        <xsl:if test="DocDate">
            <xsl:if test="DocDate != ''">
        ...
        <xsl:if test="DocIssueAuthor">
            <xsl:if test="DocIssueAuthor != ''">,
                <xsl:value-of select="DocIssueAuthor"/>
            </xsl:if>
        </xsl:if>
...
<!-- Вывод почтового адрес (если есть поле PostIndex) -->
        ...
        <xsl:if test="PostIndex">
           ...
           <xsl:if test="Country ">
               ...
               <xsl:if test="Regoin!='00' or District or City or Settlement or Street or Building or Room or Note">, </xsl:if>
           </xsl:if>
        ...
        <p class="expert">
            <xsl:if test="ExpertType">
                <xsl:if test="ExpertType != ''">
                    ...
                    <!--            <xsl:value-of select="ExpertType"/>    -->
            ...
            <xsl:if test="ExpertCertificate">
                <xsl:if test="ExpertCertificate != ''">
                    Номер квалификационного аттестата: <xsl:value-of select="ExpertCertificate"/>
                    <br/>
                    Дата выдачи квалификационного аттестата: 
                    <xsl:call-template name="formatdate">
                        <xsl:with-param name="DateTimeStr" select="ExpertCertificateBeginDate"/>
                    </xsl:call-template><br/>
                    Дата окончания срока действия квалификационного аттестата: 
                    <xsl:call-template name="formatdate">
...
<!-- Вывод сведений о физическом лице-->
    <xsl:template match="Person">
        <span class="field">ФИО: </span>
            <xsl:value-of select="FamilyName"/><xsl:text> </xsl:text>
...
<!-- Вывод наименования разделов проектной документации -->    
    <xsl:template name="MakeProjectSection">
        ...
        <xsl:if test="$Code='07.16'">Мероприятия по обеспечению доступа инвалидо</xsl:if>
    ...
    <xsl:template name="MakeTitle">
        ...
        <xsl:choose>
            <xsl:when test="$Stage=3">
                <br/>по результатам экспертного сопровождения
            </xsl:when>
        </xsl:choose>
    </xsl:template>
...
<!-- Вывод сведений о сметной стоимости (с детализации при проведении ПДОСС) -->
        ...
        <xsl:if test="Documents/Document[DocType=$Code and File]">
            <tr>
                <td colspan="5">
                    <p class="title">
                        <xsl:choose>
                            <xsl:when test="$Code='06.99'">
                                Иные отчетные материалы
                            </xsl:when>   
                            <xsl:otherwise>
                                <xsl:call-template name="MakeRII">
    ...
    <xsl:template name="MakeProjectDocumentsMismatch">
        <xsl:param name="ExpertType"/>
        <xsl:for-each select="//Conclusion/ExpertConclusion/ExpertEstimate/Mismatches/ProjectDocumentsMismatch[@ExpertType=$ExpertType]"> 
            <tr>
                <td><p class="center"><xsl:number value="position( )" format ="1. " /></p></td>
                <td><p class="left no-first-line"><xsl:value-of select="Summary"/></p></td>
                <td><p class="left no-first-line"><xsl:value-of select="Part"/></p></td>
